...
public class CompanyServiceImpl implements CompanyService
{
	...
	{
		/**
		 * Using companyDao's function to get details of all the companies.
		 */
	...
	public List<Company> getCompanyByYear(int year) 
	{
		...
		for(Company company:allCompanyList)
		{
			...
			/**
			 * Comparing the parameter passed with the value retrieved from the table column
			 * named date_of_campus.
			 * If true, then add it to the list and return the list. 
			 */
	...
	public boolean checkCompanyService(int cid) 
	{
		...
		/**
		 * Checks whether the company exists of not.
		 */
		if(company==null)
			return false;
		else
