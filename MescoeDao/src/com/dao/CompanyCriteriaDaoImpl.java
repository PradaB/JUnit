...
public class CompanyCriteriaDaoImpl implements CompanyCriteriaDao
{
	...
	/**
	 * Function to retrive company criteria for a company based on the cid passed as a parameter
	 * 
	 */
	@Override
	public List<CompanyCriteria> getCompanyCriteria(int cid) 
	{
		...
		try{
			...
			/**
			 * SQL query to display the company criteria details for a specific company Id
			 */
